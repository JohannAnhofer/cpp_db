...
elseif(APPLE)
    ...
    find_path(Firebird3_INCLUDE_DIR NAMES ibase.h HINTS "/opt/firebird" "/usr" PATH_SUFFIXES "include" ENV FIREBIRD_HOME)
    find_library(Firebird3_LIBRARY NAMES libfbclient.so HINTS "/opt/firebird" "/usr/lib/x86_64-linux-gnu" PATH_SUFFIXES "lib" ENV_FIREBIRD_HOME)
