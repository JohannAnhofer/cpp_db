...
elseif(APPLE)
    ...
    find_library(Firebird3_LIBRARY NAMES libfbclient.dylib HINTS "/Library/Frameworks/Firebird.framework" PATH_SUFFIXES "Libraries" ENV_FIREBIRD_HOME)
    get_filename_component(FB_ROOT_PATH "${Firebird3_INCLUDE_DIR}" DIRECTORY)
    execute_process(COMMAND "${FB_ROOT_PATH}/Resources/bin/gbak" -z OUTPUT_VARIABLE FB_VERSION ERROR_VARIABLE FB_ERROR)
    STRING(REGEX MATCH "([0-9]+[.])+[0-9]+" Firebird3_VERSION "${FB_VERSION}")
else()
	find_path(Firebird3_INCLUDE_DIR NAMES ibase.h HINTS "/usr/lib/x86_64-linux-gnu" "/opt/firebird" PATH_SUFFIXES "include" ENV FIREBIRD_HOME)
	find_library(Firebird3_LIBRARY NAMES libfbclient.so HINTS "/usr/lib/x86_64-linux-gnu" "/opt/firebird" PATH_SUFFIXES "lib" ENV_FIREBIRD_HOME)
